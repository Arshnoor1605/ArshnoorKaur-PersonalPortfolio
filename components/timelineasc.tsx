...
export const Timeline = ({ data }: { data: TimelineEntry[] }) => {
  ...
  return (
    <div
      ...
      ref={containerRef}
    >
      <h1 className="mb-5 p-5 text-4xl md:text-7xl font-bold text-center bg-clip-text text-transparent bg-gradient-to-b from-slate-50 to-teal-200 bg-opacity-50 underline">
        Projects
      </h1>
          ...
          >
            <div className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-full">
              <div className="h-10 absolute left-3 md:left-3 w-10 rounded-full bg-transparent dark:bg-black flex items-center justify-center">
                <div className="h-4 w-4 rounded-full bg-transparent dark:bg-neutral-800 border border-neutral-300 dark:border-neutral-700 p-2" />
              </div>
