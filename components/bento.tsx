    ...
    <div className="flex flex-1 w-full h-full min-h-[6rem] dark:bg-dot-white/[0.2] bg-dot-black/[0.2] flex-col space-y-3">
      {arr.map((_, i) => (
        <div
          ...
          className="flex items-center rounded-full border border-neutral-100 dark:border-white/[0.2] p-2 bg-slate-200 dark:bg-black h-6 relative"
        >
          <span
    ...
    >
      ...
      >
        ...
        <a
          ...
          className="border border-blue-800 bg-blue-800 dark:bg-red-900/20 text-white text-base rounded-full px-4 py-2.5 mt-4"
        >
          Myprofile
        </a>
      </motion.div>
      <motion.div className="h-full relative z-20 w-1/3 rounded-2xl bg-white p-4 dark:bg-black dark:border-white/[0.1] border border-neutral-200 flex flex-col items-center justify-center">
        ...
        <a
          href="https://drive.google.com/file/d/15fnaCIoNEl5YbJKYjM3xdDpuuVKhkpnb/view?usp=share_link"
      ...
      >
        ...
        <a
          ...
          className="border border-orange-500 bg-orange-500 dark:bg-orange-900/20 text-white text-base rounded-full px-4 py-2.5 mt-2"
        >
          Check them out
        </a>
      </motion.div>
