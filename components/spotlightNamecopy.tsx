...
export function SpotlightPreviewExp() {
  return (
    <div className="mt-10 h-full mb-10 w-full rounded-md flex md:items-center md:justify-center bg-transparent antialiased bg-grid-white/[0.02] relative overflow-hidden">
