...
export function SpotlightPreviewExp() {
  return (
    <div className="relative z-0 mt-10 h-[48rem] mb-10 w-full rounded-md flex md:items-center md:justify-center bg-black/[0.96] antialiased bg-grid-white/[0.02] overflow-hidden">
