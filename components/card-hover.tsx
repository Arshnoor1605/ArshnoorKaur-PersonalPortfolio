  ...
  return (
    <div className="max-w-5xl mx-auto px-8">
      <h2
        ...
        className="mb-2 sm:mb-2  text-4xl md:text-7xl font-bold text-center bg-clip-text text-transparent bg-gradient-to-b from-slate-50 to-teal-200 bg-opacity-50"
      >
